...
//         socket.on("chat-message", (data: ChatMessage) => chatManager(socket, data));
//         socket.on("stateUpdate", (data: GameStateUpdates) => gameManager(socket, data));

//         socket.on("registerPeerId", (peerId: string) => peerManager(socket, context));
