...
export const Dashboard = () => {
  ...
  return (
    <div className="bg-gray-100 shadow-lg rounded-lg p-4 text-teal-950 tracking-widest font-bold max-h-full overflow-auto">
      {/* Header */}
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-4">
          ...
          <ul className="mt-2 space-y-1 text-sm sm:text-base md:text-lg text-gray-700">
            {items.map((item, i) => (
              <li
                key={i}
